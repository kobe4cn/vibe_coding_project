...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/a2ui/tickets/create/stream",
            get(a2ui::ticket_create_stream),
        )
        .route(
            "/a2ui/tickets/create/action",
            post(a2ui::ticket_create_action),
        )
        // Ticket edit form
        .route(
            "/a2ui/tickets/{id}/edit/stream",
            get(a2ui::ticket_edit_stream),
        )
        .route(
            "/a2ui/tickets/{id}/edit/action",
            post(a2ui::ticket_edit_action),
        )
        // Ticket detail
        .route("/a2ui/tickets/{id}/stream", get(a2ui::ticket_detail_stream))
        .route(
            "/a2ui/tickets/{id}/action",
            post(a2ui::ticket_detail_action),
        )
        // Tags
